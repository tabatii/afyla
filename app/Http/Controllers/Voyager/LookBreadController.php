...
use App\Models\LookProduct;

class LookBreadController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function storeRelatedData($data, $id)
    {
        ...
        if (isset($data['products'])) {
            foreach ($data['products'] as $i => $product) {
                $products[$i]['look_id'] = $id;
                $products[$i]['product_id'] = $product;
            }
            LookProduct::insert($products);
        }
    }
    ...
    public function updateRelatedData($data, $id)
    {
        ...
        if (isset($data['products'])) {
            ...
            LookProduct::where('product_id', $id)->delete();
            LookProduct::insert($products);
        }
    }
}
