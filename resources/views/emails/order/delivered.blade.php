...
<body>
	<div class="mail-container">
		...
		<div class="mb-5">
			...
			<p><a href="{{route('home')}}" class="text-dark link text-decoration-none" target="_blank">afylaworld.com</a> team.</p>
		</div>
		<div>
